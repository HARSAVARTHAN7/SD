  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Confirm Exit & Logout Warning Modal */}
        {logoutModalOpen && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-100 animate-in fade-in zoom-in duration-200">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-1">Confirm Exit & Logout?</h3>
              <p className="text-slate-600 text-xs leading-relaxed mb-6">
                Are you sure you want to exit your active portal session? You will be returned to the login screen and any unsaved session state will be cleared.
              </p>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-xs font-bold text-white bg-rose-600 hover:bg-rose-700 rounded-xl transition-colors shadow-lg shadow-rose-600/30 cursor-pointer flex items-center justify-center gap-2"
                >
                  <LogOut className="w-4 h-4" />
                  Yes, Exit & Log Out
                </button>
