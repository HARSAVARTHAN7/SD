    ...
    <div className="space-y-8 pb-16">
      ...
      {currentTab === 'roster' && (
        <div className="space-y-6 animate-fadeIn">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-slate-800">Student Directory & Accommodation Control</h2>
              <p className="text-xs text-slate-500 mt-1">Assign and manage student accommodation (Day Scholar bus route or Hostel room details).</p>
            </div>
                  ...
                  {students
                    ...
                    .map((st) => (
                      <tr key={st.id} className="hover:bg-slate-50/70 transition-colors">
                        ...
                        <td className="py-4 px-4 font-medium text-slate-700">{st.phone || '+1 (555) 349-8291'}</td>
                        ...
                        <td className="py-4 px-4 text-right">
                          <button
                            onClick={() => handleOpenEditAccommodation(st)}
                            className="px-3 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-xl text-xs font-bold transition-all cursor-pointer inline-flex items-center gap-1"
                          >
